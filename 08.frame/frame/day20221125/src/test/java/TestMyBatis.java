...
public class TestMyBatis {
    ...
    public void testSelectCondition() throws IOException {
        ...
        criteria.andIdBetween(6,1050);
        criteria.andBusinessnameLike("%e%");
    ...
    @Test
    public void testSelectWithObject() throws IOException {
        //挖矿获得资金
        Reader resourceAsReader = Resources.getResourceAsReader("mybatisConfig.xml");
        //使用资金雇佣工人建造工厂
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(resourceAsReader);
        ...
        AdminMapper mapper = sqlSession.getMapper(AdminMapper.class);
        //使用mapper执行具体方法
        Admin admin = mapper.selectByPrimaryKeyWithObject(1);
        //输出
    ...
    @Test
    public void testSelectBusinessWithObject() throws IOException {
        //挖矿获得资金
        Reader resourceAsReader = Resources.getResourceAsReader("mybatisConfig.xml");
        //使用资金雇佣工人建造工厂
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(resourceAsReader);
        ...
        BusinessExample businessExample = new BusinessExample();
        BusinessExample.Criteria criteria = businessExample.createCriteria();
        criteria.andBusinessnameLike("%粉%");
//        criteria.andIdLessThan(100);
        List<Business> businessList = mapper.selectByExampleWithObject(businessExample);
        //输出
        for(Business temp:businessList){
            System.out.println(temp);
        }
    ...
    @Test
    public void testSelectInfoWithObject() throws IOException {
        //挖矿获得资金
        Reader resourceAsReader = Resources.getResourceAsReader("mybatisConfig.xml");
        //使用资金雇佣工人建造工厂
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(resourceAsReader);
        ...
        //使用mapper执行具体方法
        Info info = mapper.selectByPrimaryKeyWithObject(5);
    ...
    @Test
    public void testSelectBusinessWithObjectBySplit() throws IOException {
        //挖矿获得资金
        Reader resourceAsReader = Resources.getResourceAsReader("mybatisConfig.xml");
        //使用资金雇佣工人建造工厂
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(resourceAsReader);
        ...
        criteria.andBusinessnameLike("%粉%");
//        criteria.andIdLessThan(100);
        List<Business> businessList = mapper.selectByExampleWithObject1(businessExample);
        //输出
        for(Business temp:businessList){
            System.out.println(temp);
        }
